        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 text-sm">
            ...
            render={({ field }) => (
                ...
                <FormControl>
                    ...
                    className="w-full border-2 border-white rounded-[40px] px-8 lg:py-20 py-8 text-white placeholder-white lg:text-center h-50 bg-transparent resize-none"
                    />
                </FormControl>
                <FormMessage />
                </FormItem>
            ...
            <button
                ...
                className="bg-linear-to-r from-[#8176AF] to-[#C0B7E8] text-gray-900 lg:px-14 py-4 rounded-[40px] font-bold text-sm w-full lg:max-w-3xs cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
            >
